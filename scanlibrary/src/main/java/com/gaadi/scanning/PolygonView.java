...
public class PolygonView extends FrameLayout {
    ...
    private void initPaint() {
        paint = new Paint();
        paint.setColor(getResources().getColor(com.gaadi.R.color.blue));
    ...
    private ImageView getImageView(int x, int y) {
        ...
        imageView.setImageResource(com.gaadi.R.drawable.circle);
        imageView.setX(x);
        imageView.setY(y);
            ...
            switch (eid) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (isValidShape(getPoints())) {
                        color = getResources().getColor(com.gaadi.R.color.blue);
                    } else {
                        color = getResources().getColor(com.gaadi.R.color.orange);
                    }
