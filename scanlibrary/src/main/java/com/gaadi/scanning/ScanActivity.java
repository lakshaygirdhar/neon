...
import com.gaadi.fragment.CameraPriorityFragment;
import com.gaadi.util.CameraPreview;
import com.gaadi.util.Constants;
import com.gaadi.util.DrawingView;
...
public class ScanActivity extends AppCompatActivity implements IScanner, View.OnTouchListener, CameraPriorityFragment.PictureTakenListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.gaadi.R.layout.camera_priority_items);
        ...
        if (null != photoParams) {
            ...
            manager.beginTransaction().replace(com.gaadi.R.id.content_frame, fragment).commit();
        } else {
...
//        matrix.mapRect(rectF);
    ...
    private void scanFragmentForCropping(File file) {
        ...
        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
        fragmentTransaction.add(com.gaadi.R.id.content_frame, fragment);
