...
import com.gaadi.adapter.ImagesReviewViewPagerAdapter;
import com.gaadi.event.ImageEditEvent;
import com.gaadi.interfaces.FragmentListener;
import com.gaadi.model.ImageModel;
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.gaadi.R.layout.activity_imagereview);
        toolbar = (Toolbar) findViewById(com.gaadi.R.id.image_review_toolbar);
        setSupportActionBar(toolbar);
        mDoneButton = (TextView) findViewById(com.gaadi.R.id.image_review_toolbar_doneBtn);
        mDoneButton.setOnClickListener(this);
        mPager = (ViewPager) findViewById(com.gaadi.R.id.pager);
        viewPagerLeftBtn = (ImageView) findViewById(com.gaadi.R.id.view_pager_leftbtn);
        viewPagerRightBtn = (ImageView) findViewById(com.gaadi.R.id.view_pager_rightbtn);
        viewPagerRightBtn.setOnClickListener(this);
        viewPagerLeftBtn.setOnClickListener(this);
        mTitle = (TextView) findViewById(com.gaadi.R.id.image_review_toolbar_title);
...
//        }
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == com.gaadi.R.id.image_review_toolbar_doneBtn) {
            Intent i = new Intent();
            i.putExtra(ScanConstants.IMAGE_MODEL_FOR__REVIEW, imagesList);
            setResult(RESULT_OK, i);
            finish();
        } else if (id == com.gaadi.R.id.view_pager_leftbtn) {
        ...
        } else if (id == com.gaadi.R.id.view_pager_rightbtn) {
            int position = mPager.getCurrentItem();
            if (position < imagesList.size() - 1) {
                position++;
                mPager.setCurrentItem(position);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.gaadi.R.menu.menu_view_pager, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == com.gaadi.R.id.menu_done) {
            onBackPressed();
            return true;
        }
