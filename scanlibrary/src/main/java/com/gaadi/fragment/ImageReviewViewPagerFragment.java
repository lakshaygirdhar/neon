...
import com.gaadi.interfaces.FragmentListener;
...
//        args.putSerializable(ScanConstants.IMAGE_TAGS_FOR_REVIEW, imageTags);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater
                .inflate(com.gaadi.R.layout.fragment_image_review_viewpager, container, false);
//        ButterKnife.bind(this, rootView);

        deleteBtn = (ImageView) rootView.findViewById(com.gaadi.R.id.imagereview_deletebtn);
        cropBtn=(ImageView)rootView.findViewById(com.gaadi.R.id.imagereview_cropbtn);
        rotateBtn = (ImageView) rootView.findViewById(com.gaadi.R.id.imagereview_rotatebtn);
//        txtVwTagSpinner = (TextView) rootView.findViewById(R.id.imagereview_tag_spinner);
        draweeView = (ImageView) rootView.findViewById(com.gaadi.R.id.imagereview_imageview);
...
//        }
        ...
        Glide.with(mContext).load(imageModel.getFilePath())
                .placeholder(com.gaadi.R.drawable.default_placeholder)
...
//            clearFrescoCache(Uri.fromFile(new File(imageModel.getImagePath())));
        ...
        } else if (v.getId() == com.gaadi.R.id.imagereview_tag_spinner) {
//            showTagsDropDown();
        }
        else if(v.getId()== com.gaadi.R.id.imagereview_cropbtn){
            //TODO PRINCE
...
//            Crop.of(inputUri, outputUri).start(getActivity(),ImageReviewViewPagerFragment.this);
    ...
    private void warnDeleteDialog(final ImageEditEvent event) {
        ...
        builder.setTitle(com.gaadi.R.string.remove_img_title);
        builder.setMessage(com.gaadi.R.string.removeImage);
        builder.setCancelable(false);
        builder.setPositiveButton(com.gaadi.R.string.okDialog, new DialogInterface.OnClickListener() {
            @Override
        ...
        builder.setNegativeButton(com.gaadi.R.string.cancelDialog, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
            }
