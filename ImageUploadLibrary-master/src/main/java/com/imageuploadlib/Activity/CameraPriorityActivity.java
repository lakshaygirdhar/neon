...
public class CameraPriorityActivity extends AppCompatActivity
        implements View.OnTouchListener, CameraPriorityFragment.PictureTakenListener {
...
//        } else {
            CameraPriorityFragment fragment1 = CameraPriorityFragment.getInstance(photoParams);
            FragmentManager manager = getSupportFragmentManager();
...
//        fragmentTransaction.addToBackStack(CameraPriorityActivity.class.toString());
//        fragmentTransaction.commit();
//    }
//
//    @Override
//    public void onScanFinish(Uri uri) {
//        Log.d(TAG,"cropping completed");
//    }
